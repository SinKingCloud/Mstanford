...
class Mstanford
{
    private $ApiUrl = array('pc' => 'https://www.51moot.net/', 'mobile' => 'http://39.97.1.38/');
    private $sign; //签名
    ...
    {
        $signs = Cache::get("MstanfordSign");
        if (empty($signs) || $signs == "") {
            ...
            if ($arr['code'] == 0) {
                Cache::set("MstanfordSign", $this->sign, 36000);
                return $arr['data'];
            } else {
                return false;
            }
